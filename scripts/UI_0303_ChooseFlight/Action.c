Action()
{
    lr_start_transaction("03_GenetalTransaction");
	...
	web_submit_data("login.pl", 
		...
		"Name=username", "Value={Username_1}", ENDITEM, 
		"Name=password", "Value={Password_2}", ENDITEM, 
...
//	lr_save_string(lr_paramarr_random("outboundFlight"), "outboundFlight_rnd") 
	...
	lr_end_transaction("03_GenetalTransaction", LR_AUTO);
